...
export const Map = forwardRef(
  ({ searchCenter, searchRadius, selectedCuisine, selectedTags }, ref) => {
    ...
    const {
      ...
      radius: searchRadius / 1000, // Convert meters to km
                    ...
                    <TouchableOpacity onPress={() => handleMarkerPress(index)}>
                      <Animated.View
                        style={[
                          ...
                          selectedMarkerCoords.latitude ===
                            restaurant.latitude &&
                          selectedMarkerCoords.longitude ===
            ...
            {(!restaurants || restaurants.length === 0) && (
              <View style={styles.overlay}>
                <Text style={styles.overlayText}>
                  Coming soon! Stay tuned for exciting restaurants in your area.
                </Text>
              </View>
            )}
